...
@section('content')
    ...
    <div class="container p-2 sm:p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="card bordered pt-2">
                <figure >
                    <i class="fas fa-certificate text-blue-500 text-3xl"></i>
                </figure>
            ...
            <div class="card bordered pt-2">
                <figure>
                    <i class="fas fa-id-badge text-green-500 text-3xl"></i>
                </figure>
                <div class="card-body flex items-center justify-center">
            ...
            <div class="card bordered pt-2">
                <figure>
                    <i class="fas fa-phone text-indigo-500 text-3xl"></i>
                </figure>
                <div class="card-body flex items-center justify-center">
