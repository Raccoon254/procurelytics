        ...
        <form action="{{ route('procurement.store') }}" method="post" enctype="multipart/form-data" class="w-full max-w-3xl mx-3">
            ...
            <div class="grid gap-5 lg:grid-cols-2">
                <div class="space-y-1">
                    ...
                    <input type="text" id="firm_name" name="firm_name" class="w-full input input-bordered">
                </div>

                <div class="space-y-1">
                    <label for="certificate_number" class="text-sm font-medium">Certificate Number:</label>
                    <input type="text" id="certificate_number" name="certificate_number" class="w-full input input-bordered">
                </div>

                <div class="space-y-1">
                    <label for="agpo_cert_no" class="text-sm font-medium">AGPO CERT NO:</label>
                    <input type="text" id="agpo_cert_no" name="agpo_cert_no" class="w-full input input-bordered">
                </div>

                <div class="space-y-1">
                    <label for="category_id" class="text-sm font-medium">Category:</label>
                    <select id="category_id" name="category_id" class="w-full input input-bordered select">
                ...
                <div class="space-y-1">
                    ...
                    <textarea id="directors" name="directors" class="w-full input input-bordered textarea"></textarea>
                </div>

                <div class="space-y-1">
                    <label for="postal_address" class="text-sm font-medium">Postal Address:</label>
                    <input type="text" id="postal_address" name="postal_address" class="w-full input input-bordered">
                </div>
                ...
                <div class="space-y-1">
                    ...
                    <input type="tel" id="mobile_number" name="mobile_number" class="w-full input input-bordered">
                </div>

                <div class="space-y-1">
                    <label for="amount" class="text-sm font-medium">Amount:</label>
                    <input type="number" id="amount" name="amount" class="w-full input input-bordered">
                </div>

                <div class="space-y-1">
                    <label for="spend_category_id" class="text-sm font-medium">Spend Category:</label>
                    <select id="spend_category_id" name="spend_category_id" class="w-full input input-bordered">
                ...
                <div class="space-y-1">
                    ...
                    <input type="number" id="procurement_number" name="procurement_number" class="w-full input input-bordered">
                </div>

                <div class="space-y-1">
                    <label for="procurement_method" class="text-sm font-medium">Method of Procurement:</label>
                    <input type="text" id="procurement_method" name="procurement_method" class="w-full input input-bordered">
                </div>
                ...
                <div>
                    <button type="submit" class="btn btn-outline ring">
                        Submit
