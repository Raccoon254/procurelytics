    ...
    <section class="flex relative flex-col gap-4 p-3 sm:p-6">
        ...
        <dialog id="my_modal_1" class="modal">
            <form method="dialog" class="modal-box relative">
                <h3 class="font-bold text-lg">Complete Data Confirmation</h3>
                <p class="py-4">Please confirm the data below and click upload</p>
        ...
        <section class="flex justify-center gap-4">
            ...
            <div data-tip="Click to confirm Upload" class="flex tooltip justify-center">
                <form action="{{ route('procurement.confirm-upload') }}" method="POST">
                    @csrf
                    <button type="submit" class="btn bg-red-300 hover:btn-warning btn-circle ring">
                        <i class="fa-solid fa-bolt"></i>
                    </button>
                </form>
            </div>

            <div data-tip="Click to Reupload File" class="flex tooltip justify-center">
                <a href="{{ route('procurement.create') }}" class="btn btn-circle ring">
                    <i class="fa-solid fa-file-arrow-up"></i>
                </a>
            </div>

            <div data-tip="Click to View Procurement data" class="flex tooltip justify-center">
