<div class="navbar z-50 bg-base-700">
    <div class="navbar-start">
        <label for="my-drawer" class="btn btn-circle drawer-button swap swap-rotate">
            ...
            <!-- hamburger icon -->
            <svg data-tip="Open ProcureLytics content" class="swap-off fill-current tooltip tooltip-right" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512"><path d="M64,384H448V341.33H64Zm0-106.67H448V234.67H64ZM64,128v42.67H448V128Z"/></svg>
    ...
    <div class="navbar-center">
        <a class="normal-case text-xl">ProcureLytics™️</a>
    </div>
